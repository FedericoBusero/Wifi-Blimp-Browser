...
// Pas de voltagefactor aan, dat is bij elke chip verschillend. Calibreer met extern gemeten spanning
#define VOLTAGE_FACTOR 820.0f 

#define LED_BRIGHTNESS_ON  LOW
#define LED_BRIGHTNESS_OFF HIGH

#elif defined(ENV_BLIMP_ESP32C3_WROOM_V3) || defined(ENV_BLIMP_ESP32C3_WROOM_V3_REVERSED_MOTORS) //PCB V3, V3.1, V3.2 & V3.3,  Makerday Hasselt 2025, Maker Days Eindhoven 2025, Maker Faire Gent 2026
